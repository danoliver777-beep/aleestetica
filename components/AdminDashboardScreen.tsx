                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {selectedAppointment.profile?.phone && (
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          const phone = selectedAppointment.profile?.phone?.replace(/\D/g, '');
                          if (phone) window.open(`https://wa.me/55${phone}`, '_blank');
                        }}
                        className="flex items-center justify-center h-7 w-7 rounded-full bg-[#25D366] text-white hover:bg-[#20bd5a] transition-colors shadow-sm"
                        title={`WhatsApp: ${selectedAppointment.profile.phone}`}
                      >
